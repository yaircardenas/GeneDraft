...
APP_AUTHOR = "PhD. Yair Cardenas-Conejo"
APP_CONTACT_EMAIL = "ycardenasco@secihti.mx"
APP_AFFILIATION = (
    "Researcher for Mexico, Secretariat of Science, Humanities, Technology and Innovation; "
    "University of Colima; Virology, Genomics and Biotechnology Laboratory; "
    "University Center for Biomedical Research; Mexico."
)
APP_DESCRIPTION = (
...
class GeneDraftApp:
    ...
    def _about_citation_text(self) -> str:
        return (
            "Suggested citation\n\n"
            f"Cardenas-Conejo Y. ({APP_RELEASE_YEAR}). GeneDraft (Version {APP_VERSION}) "
            "[Computer software]. Investigador por Mexico, Secretaria de Ciencias, "
            "Humanidades, Tecnologia e Innovacion; Universidad de Colima; Laboratorio de "
            "Virologia, Genomica y Biotecnologia; Centro Universitario de Investigaciones "
            f"Biomedicas. {APP_REPOSITORY_URL}.\n\n"
            "Citation note\n"
